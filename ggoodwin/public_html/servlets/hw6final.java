...
public class MovieUpdate extends HttpServlet {
 ...
 private void processForm(HttpServletRequest request, PrintWriter out, Connection dbh)
        throws SQLException
    {
      ...
      if (submit == Choose using menu){

      }
      if (submit == Delete this menu){

      }

      if (submit = Search by title){
  ...
  /* Set up the webform */
	...
	out.println("<p>Director <input type='text' name='director'>");
        ...
        out.println("</select>");
        out.println("<p><input type='submit' name='submit' value='"+Choose using menu+"'>");
	out.println("<p><input type='submit' name='submit' value='"+Delete this movie+"'>");
	out.println("<p><input type='submit' name='submit' value='"+Search by title+"'>");
	out.println("<p><input type='submit' name='submit' value='"+Update movie+"'>");
