...
public class RunTournament {  
  ...
  // PURPOSE: creates an initial 16 teams for Euro2004 soccer tournament 
  ...
  private static void createAndShowGUI() {
    ...
    JFrame frame = new JFrame("EURO 2004 - European Football Tournament");
    ...
    Tournament euro2004 = new Tournament(makeTeams());
    euro2004.init(); 
    
    // frame.getContentPane().add(contents, BorderLayout.CENTER);
    frame.add(euro2004, BorderLayout.CENTER);
