...
public class BTNode<T> {
  ...
  */
  ...
  /**
   * It finds and returns the heoght of this node.
   * If the node has no left and right nodes, then
   * it is at level zero.
   */
  public int height() {
    int l = 0;
    ...
    } //or else both left and right nodes are null
    else return 0;
  }
  
  /**
   * It spins the node in such a way that the left node of this node
   * becomes its right, and vice versa. The initial node is modified.
   */
  public void spin() {
    BTNode<T> temp = left;
    left = right;
