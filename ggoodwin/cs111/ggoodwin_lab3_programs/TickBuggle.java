public class TickBuggle extends Buggle {
	...
	public void tick() {
	// A hook that allows subclass instances to perform some action on every clock tick. 
	...
	// we can only ask buggles to perform an action a predetermined number of times. 
