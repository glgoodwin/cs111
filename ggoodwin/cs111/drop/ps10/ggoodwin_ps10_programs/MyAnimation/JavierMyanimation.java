...
class JavierMyanimation extends Animation { 

    public JavierMyanimation(){
//part 1
...
//part 3
      ...
      this.addSprite(r8);//sets active and inactive for text listed above
      this.addSprite(r9);
      this.addSprite(r10);
      this.setHidden(r8,1);
      this.setHidden(r9,1);
...
//Part 4
      ...
      this.addSprite(r15);//this sets active and inactive for all the text listd above
      this.addSprite(r16);
      this.addSprite(r17);
      this.addSprite(r18);
      this.addSprite(r19);
