// Modified by MAS Summer 2007
// * Use Swing classes
// * Expand constructors so width and height may be omitted (in which case
//   the pack() method uses the layout manager to pick the size)
//
// Modified by lyn on 03/10/03 to include result names
// Modified by lyn on 11/13/06 to handle colors
...
public class ParameterFrame extends JFrame 
{
                           ...
                           String [] resultNames) 
    {
        ...
        params = new ParameterPanel(paramNames, resultNames);
        content.add(params);
    ...
    {
        this(title, paramNames, resultNames);
