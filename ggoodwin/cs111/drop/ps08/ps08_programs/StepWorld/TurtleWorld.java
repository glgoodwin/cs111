...
History:
 ...
 [mas, 03/01/06] Rewritten as part of the conversion to Swing.
                 ...
                 Issues and questions:
                  ...
                  o Why do we keep a vector of turtles in TurtleWorld
                  and send them home on Reset?  The only thing the use
                  can do after Reset is Run again, which will create
                  the turtles all over again.  This is a storage leak:
                  We should just let them be GC-ed.

                  o Swing documentation cautions against overriding
                  the paint() method.
  ------------------------------------------------------------------
...
public class TurtleWorld extends JApplet implements ActionListener
{
    ...
    private static Vector turtles = new Vector();

    private boolean hasRun;

    //----------------------------------------------------------------------
    /*** [brian, 10/02/07] New code for running a TurtleWorld applet as an application ***/
   ...
   public void run() { // this is Java's thread run() method, not TurtleWorld's!
